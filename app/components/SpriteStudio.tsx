    ...
    <>
        ...
        <div className="stage-canvas">
          {hasAny || anchor ? (
            ...
            <div className="stage-empty">
              <h1 className="font-display">Sprite sheet</h1>
              <p>Generate a sheet to see the animation play</p>
            </div>
          )}
        </div>
      </section>
      ...
      <aside className="inspector">
        <div className="inspector-header">
          <h2>Sprite sheet</h2>
          <span>Pick a body plan + animation, then generate</span>
        </div>

        <div className="inspector-body">
          {/* Body-plan picker. Switching plan swaps the pose rig, the
              available animations, and the starter presets. */}
          <div className="inspector-label">Body plan</div>
          ...
          {/* Animation type picker (scoped to the current body plan) */}
          <div className="inspector-label">Animation</div>
          <div className="flex flex-wrap gap-1.5">
          ...
          {/* Re-roll the character anchor (keeps prompt, fresh anchor + sheet) */}
          {anchor && !generating && (
            <button
        ...
        <div className="inspector-selection">
          ...
          <button
            onClick={onDownloadRig}
            disabled={!hasAny || generating}
            className="btn btn-ghost"
            title="Export a Spine rig — skeleton.json + .atlas + strip, plays the animation; ships a body-plan bone skeleton"
          >
